...
Route::post('/login',[UserAuthController::class, 'submitLoginForm'])->middleware('CheckRequestMethod', 'throttle: 3, 1')->name('user.login');
...
Route::middleware(UserMiddleware::class)->group(function(){
    ...
    Route::post('/profile/update', [UserRegistrationController::class, 'userProfileUpdatePost'])->middleware(CheckRequestMethod::class)->name('update.profile.post');
});
...
Route::post('/opinion', [UserRegistrationController::class, 'opinionSubmit'])->middleware(CheckRequestMethod::class)->name('opinion.submit');

Route::post('/calculate-payment-and-participants', [UserRegistrationController::class, 'paymentAndParticipants'])->middleware(CheckRequestMethod::class)->name('payment.participants');
...
Route::post('/submitted-otp',[UserRegistrationController::class, 'otpVerify'])->middleware(CheckRequestMethod::class)->name('submitted.otp.verification');
...
Route::prefix('admin')->group(function (){
    ...
    Route::post('/login', [AdminController::class, 'login'])->middleware('CheckRequestMethod', 'throttle: 3, 1')->name('admin.login');
    ...
    Route::middleware(AdminMiddleware::class)->group(function () {
        ...
        Route::post('/user/update/given',[UserRegistrationController::class, 'updateGivenData'])->middleware(CheckRequestMethod::class)->name('user.update.given');
